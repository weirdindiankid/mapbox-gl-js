...
module.exports = {
    ...
    rasterTerrain: {
        fragmentSource: fs.readFileSync(path.join(__dirname, '../../shaders/raster_terrain.fragment.glsl'), 'utf8'),
        vertexSource: fs.readFileSync(path.join(__dirname, '../../shaders/raster_terrain.vertex.glsl'), 'utf8')
    },
    symbolIcon: {
